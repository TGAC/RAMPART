 ...
 * Time: 13:44
 */
public class GapCloserV112Process extends AbstractConanProcess implements Degapper {
    ...
    @Override
    public DegapperArgs getArgs() {
        return (DegapperArgs)this.getProcessArgs();
    }

    @Override
    public void setArgs(DegapperArgs degapperArgs) {
        this.setProcessArgs(degapperArgs);
    }
