 ...
 **/
package uk.ac.tgac.rampart.pipeline.tool.proc.mass.stats;
...
public class MassSelectorProcess extends AbstractConanProcess {
  ...
  /*
# This script processes the tables produced from the raw and quality trimmed datasets and then determines the best assembly to use for the subsequent scaffolding proc
