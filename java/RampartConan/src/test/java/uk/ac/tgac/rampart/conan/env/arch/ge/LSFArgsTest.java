...
import uk.ac.tgac.rampart.conan.env.arch.ge.LSFWaitCondition.ExitStatus;
...
public class LSFArgsTest {
	...
	public void testFullArgs1() {
		...
		args.setWaitCondition(new LSFWaitCondition(ExitStatus.ENDED, "Job0"));
		args.setMemoryMB(60000);
		
		String test = args.toString();
		
		String correct = "-J Job1 -n 8 -q production -P ProjectRampart -a openmpi -w ended(Job0) -Rusage[mem=60000]span[ptile=8]";
