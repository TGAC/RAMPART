...
public class QTProcessTest {
    ...
    public void localQTTest() throws InterruptedException, ProcessExecutionException, IOException, CommandExecutionException {
        ...
        SickleV11Task sickle = mock(SickleV11Task.class);
        ...
        when(taskExecutionService.execute(sickle, ec)).thenReturn(0);

        ReflectionTestUtils.setField(simpleQTProcess, "taskExecutionService", taskExecutionService);

        simpleQTProcess.execute(ec);
    }
