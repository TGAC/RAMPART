...
import uk.ac.tgac.rampart.conan.conanx.process.AbstractProcessAdapter;
 ...
 * Time: 17:51
 */
public class LSFProcessAdapter extends AbstractProcessAdapter {

    private static Logger log = LoggerFactory.getLogger(LSFProcessAdapter.class);
