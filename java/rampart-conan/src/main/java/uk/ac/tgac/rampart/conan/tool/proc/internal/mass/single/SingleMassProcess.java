 ...
 **/
package uk.ac.tgac.rampart.conan.tool.proc.internal.mass.single;
...
import uk.ac.tgac.rampart.conan.tool.proc.internal.util.PerlHelper;
...
public class SingleMassProcess extends AbstractConanXProcess {
    ...
    public boolean execute(ExecutionContext executionContext) throws ProcessExecutionException, InterruptedException {
        ...
        try {
            ...
            for (int k = getFirstValidKmer(args.getKmin()); k <= args.getKmax(); k = nextKmer(k)) {
                ...
                // Create proc
                this.processExecutionService.execute(args.getAssembler(), asmExeCtx);
            }
