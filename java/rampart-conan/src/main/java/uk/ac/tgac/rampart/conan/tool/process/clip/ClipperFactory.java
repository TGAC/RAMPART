 ...
 **/
package uk.ac.tgac.rampart.conan.tool.process.clip;

import uk.ac.tgac.rampart.conan.tool.process.clip.internal.RampartClipperProcess;
import uk.ac.tgac.rampart.conan.tool.process.degap.Degapper;
import uk.ac.tgac.rampart.conan.tool.process.degap.gapcloser.GapCloserV112Process;
...
public enum ClipperFactory {
    ...
    RAMPART_CLIPPER {
        ...
        public Clipper create(ClipperArgs args) {
            return new RampartClipperProcess(args);
        }   */
    };
