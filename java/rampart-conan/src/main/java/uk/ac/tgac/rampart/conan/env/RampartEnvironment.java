...
public interface RampartEnvironment {

	void setup(Locality locality, Architecture architecture);
	
	void submitProcess(RampartProcess rampartProcess, EnvironmentArgs args)
