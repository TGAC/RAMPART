 ...
 **/
package uk.ac.tgac.rampart.conan.tool.task.external.qt;

import uk.ac.tgac.rampart.conan.conanx.param.FilePair;
import uk.ac.tgac.rampart.conan.tool.task.external.qt.sickle.SicklePeV11Args;
import uk.ac.tgac.rampart.conan.tool.task.external.qt.sickle.SickleSeV11Args;
import uk.ac.tgac.rampart.conan.tool.task.external.qt.sickle.SickleV11Task;
...
public enum QualityTrimmerFactory {
    ...
    SICKLE_SE_V1_1 {
        ...
        public QualityTrimmer createQT(QualityTrimmerArgs args) {
            return new SickleV11Task(SickleV11Task.JobType.SINGLE_END, args);
        }
    ...
    SICKLE_PE_V1_1 {
        ...
        @Override
        public QualityTrimmer createQT(QualityTrimmerArgs args) {
            return new SickleV11Task(SickleV11Task.JobType.PAIRED_END, args);
        }
