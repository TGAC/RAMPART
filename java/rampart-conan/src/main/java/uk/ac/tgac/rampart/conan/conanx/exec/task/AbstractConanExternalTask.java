 ...
 * Time: 13:55
 */
public abstract class AbstractConanExternalTask implements ConanExternalTask {
    ...
    protected AbstractConanExternalTask(String executable) {
    ...
    /**
     * Creates a command line to execute from the supplied task args.  The are various means of constructing the command
     ...
     * @param args The task arguments from which to build a command line to execute.
