 ...
 **/
package uk.ac.tgac.rampart.conan.tool.proc.mass.stats;
...
public class MassSelector implements ConanProcess, RampartProcess {
    ...
    public MassSelector(List<File> statsFiles, List<File> configs, File outputDir, long approxGenomeSize, AssemblyStatsMatrixRow weightings) {
    ...
    @Override
    public void execute(ExecutionContext env) throws IOException, ProcessExecutionException, InterruptedException, CommandExecutionException {
  ...
  /*
# This script processes the tables produced from the raw and quality trimmed datasets and then determines the best assembly to use for the subsequent scaffolding task
