...
public enum GridEngineType {

	LSF {
        @Override
        public GridEngineArgs createArgs() {
            return new LSFArgs();  //To change body of implemented methods use File | Settings | File Templates.
        }

        @Override
		public AbstractGridEngine create() {
			return new LSF();
		}
	},
	PBS {
	...
	public abstract AbstractGridEngine create();
    public abstract GridEngineArgs createArgs();
}
