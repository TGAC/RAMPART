...
import uk.ac.tgac.rampart.conan.conanx.exec.context.scheduler.pbs.PBSArgs;
...
public enum SchedulerType {
	...
	LSF {
		...
		public AbstractScheduler create() {
			return new uk.ac.tgac.rampart.conan.conanx.exec.context.scheduler.lsf.LSF();
		}
	...
	PBS {
		@Override
		public AbstractScheduler create() {
			return new uk.ac.tgac.rampart.conan.conanx.exec.context.scheduler.pbs.PBS();
		}
