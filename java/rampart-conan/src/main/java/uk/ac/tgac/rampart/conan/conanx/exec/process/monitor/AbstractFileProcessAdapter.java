 ...
 * Time: 17:27
 */
public abstract class AbstractFileProcessAdapter extends File implements ProcessAdapter {
    ...
    private static Logger log = LoggerFactory.getLogger(AbstractFileProcessAdapter.class);

    protected AbstractFileProcessAdapter(String pathname, int monitoringPeriod) {
        super(pathname);
        this.fileMonitor = new OutputFileMonitor(this, monitoringPeriod);
        this.listeners = new HashSet<ProcessListener>();
    }

    protected AbstractFileProcessAdapter(String parent, String child, int monitoringPeriod) {
        super(parent, child);
        this.fileMonitor = new OutputFileMonitor(this, monitoringPeriod);
        this.listeners = new HashSet<ProcessListener>();
    }

    protected AbstractFileProcessAdapter(File parent, String child, int monitoringPeriod) {
        super(parent, child);
        this.fileMonitor = new OutputFileMonitor(this, monitoringPeriod);
        this.listeners = new HashSet<ProcessListener>();
    }

    protected AbstractFileProcessAdapter(URI uri, int monitoringPeriod) {
        super(uri);
        this.fileMonitor = new OutputFileMonitor(this, monitoringPeriod);
        this.listeners = new HashSet<ProcessListener>();
    }
