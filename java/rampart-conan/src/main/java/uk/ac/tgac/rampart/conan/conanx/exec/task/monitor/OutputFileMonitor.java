...
public class OutputFileMonitor implements Runnable {
    ...
    public OutputFileMonitor(TaskAdapter taskAdapter, int interval) {
        this.taskAdapter = taskAdapter;
        this.outputFile = taskAdapter.getFile();
            ...
            synchronized (outputFile) {
                ...
                if (outputFile.exists()) {
                    ...
                    if (!fileExisted) {
                        ...
                        taskAdapter.fireOutputFileDetectedEvent(outputFile.lastModified());
                    }
                    else {
                        ...
                        if (outputFile.lastModified() > lastModified ||
                            ...
                            taskAdapter.fireOutputFileUpdateEvent(outputFile.lastModified());
                        }
                    }
                }
                else {
                    if (fileExisted) {
                        ...
                        // therefore it has been deleted by an task task
                        log.debug("File previously existed but has been deleted");
                        taskAdapter.fireOutputFileDeleteEvent(outputFile.lastModified());
                    }
                }
