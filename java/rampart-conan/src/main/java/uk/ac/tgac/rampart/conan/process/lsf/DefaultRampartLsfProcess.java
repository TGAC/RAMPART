...
public abstract class DefaultRampartLsfProcess extends AbstractLSFProcess {

	private static final long serialVersionUID = -1289512647365536443L;

	private static Logger log = Logger.getLogger(DefaultRampartLsfProcess.class);
	...
	public DefaultRampartLsfProcess(String name, String componentName, String command, String paramPrefix,
