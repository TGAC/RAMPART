 ...
 */
public class KmerAnalysisReadsArgs implements RampartStageArgs {
    ...
    public KmerAnalysisReadsArgs(Element element, List<Library> allLibraries, List<EcqArgs> allMecqs, String jobPrefix, File mecqDir,
