...
import uk.ac.tgac.conan.process.clip.ClipperFactory;
import uk.ac.tgac.conan.process.dedup.DeduplicatorFactory;
import uk.ac.tgac.conan.process.degap.DegapperFactory;
import uk.ac.tgac.conan.process.scaffold.ScaffolderFactory;
