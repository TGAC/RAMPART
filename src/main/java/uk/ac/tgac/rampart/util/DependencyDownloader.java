...
public class DependencyDownloader {
    ...
    public void run(File targetDir) throws IOException {
        ...
        downloadFromUrl(
                new URL("http://www.bcgsc.ca/platform/bioinfo/software/abyss/releases/1.3.6/abyss-1.3.6.tar.gz"),
                new File(abyssDir, "abyss-1.3.6.tar.gz"));
        ...
        // ALLPATHS-LG
        downloadFromUrl(
                new URL("ftp://ftp.broadinstitute.org/pub/crd/ALLPATHS/Release-LG/latest_source_code/allpathslg-47719.tar.gz"),
                new File(massDir, "allpathslg-47719.tar.gz"));
        ...
        downloadFromUrl(
                new URL("ftp://ftp.ncbi.nlm.nih.gov/blast/executables/blast+/LATEST/ncbi-blast-2.2.28+-src.tar.gz"),
