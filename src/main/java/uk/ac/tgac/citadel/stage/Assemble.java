 ...
 */
public class Assemble extends AbstractConanProcess {

    private static Logger log = LoggerFactory.getLogger(Assemble.class);

    public Assemble() {
        this(null);
    }

    public Assemble(ConanExecutorService ces) {
       this(ces, new Args());
    }

    public Assemble(ConanExecutorService ces, Args args) {
